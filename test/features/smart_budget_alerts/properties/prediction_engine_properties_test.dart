...
void main() {
  ...
  group('Property 4: Projection calculation correctness', () {
    ...
    Glados(any.intInRange(0, 999999)).test(
      ...
      (seed) {
        ...
        expect(
          ...
          reason:
              'calculateSpendingRate($totalSpent, $elapsedDays) '
    ...
    Glados(any.intInRange(0, 999999)).test(
      ...
      (seed) {
        ...
        final spendingRate = engine.calculateSpendingRate(
          totalSpent,
          elapsedDays,
        );
        ...
        expect(
          ...
          reason:
              'projectTotalSpending should equal '
  ...
  group('Property 6: Prediction alerts only generated within current budget period', () {
    late PredictionEngineService engine;
    ...
    ).test('no alert when overspend date falls after period end (low daily rate)', (
      seed,
    ) {
      final rng = Random(seed);
