...
void main() {
  group('LocationClusteringService Tests', () {
    ...
    test('should return empty list when transactions count with location < 3', () {
      final transactions = [
        TransactionModel(
          userId: 'user-1',
          amount: 10000,
    ...
    test('should group nearby points into a single cluster and calculate correct centroid', () {
    ...
    test('should identify high-spending clusters even if they have < 3 transactions', () {
      final now = DateTime.now();
      final transactions = [
    ...
    test('should prioritize hotspots by spending amount and limit to top 5', () {
      ...
      for (int i = 0; i < 6; i++) {
        ...
        final double amount = (i + 1) * 100000.0; // spending increases with i (from 100k to 600k total per transaction)
