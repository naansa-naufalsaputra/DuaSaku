...
final transactionEventBusProvider =
    Provider<StreamController<TransactionEvent>>((ref) {
...
final transactionEventSinkProvider = Provider<StreamSink<TransactionEvent>>((
  ref,
) {
  final controller = ref.watch(transactionEventBusProvider);
