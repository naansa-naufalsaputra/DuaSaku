...
abstract class BillReminderRepositoryInterface {
  Future<Result<List<BillReminderModel>, AppError>> getBillReminders(String userId);
  Future<Result<BillReminderModel?, AppError>> getBillReminderById(String reminderId);
