...
class BillReminderListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      backgroundColor: Colors.transparent,
      appBar: GlassAppBar(title: Text('bill_reminders.title'.tr())),
      body: Stack(
        children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      ref
                          ...
                          .deleteBillReminder(reminder.id);
                    },
                  ),
              ],
            ),
              ...
              children: [
                ...
                Text(
                  'bill_reminders.days_before'.tr(
                    args: [reminder.reminderDaysBefore.toString()],
                  ),
                  style: TextStyle(
                    fontSize: 10,
...
class _MarkPaidBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_MarkPaidBottomSheet> createState() =>
      _MarkPaidBottomSheetState();
}
