...
class _ManageWalletsScreenState extends ConsumerState<ManageWalletsScreen> {
  ...
  List<Color> _getGradientForType(String type, bool isDark) {
    switch (type.toLowerCase()) {
      case 'bank':
        return [const Color(0xFF3B82F6), const Color(0xFF1D4ED8)]; // Indigo/Blue
      case 'e-wallet':
        return [const Color(0xFF8B5CF6), const Color(0xFF6D28D9)]; // Purple/Pink
      case 'cash':
        return [const Color(0xFF10B981), const Color(0xFF047857)]; // Emerald/Teal
      default:
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // Title
                  Text(
                    walletToEdit == null ? 'Add New Wallet' : 'Edit Wallet',
                  ...
                  GlassInputField(
                    ...
                    labelText: 'Wallet Name (e.g. BCA, Gopay, Cash)',
                    errorText: nameError,
                    onChanged: (_) {
                  ...
                  const SizedBox(height: 20),
                    ...
                    Row(
                      children: ['Bank', 'E-Wallet', 'Cash'].map((type) {
                        final isSelected = walletType.toLowerCase() == type.toLowerCase();
                        final icon = _getIconForType(type);
                        
                        Color accentColor;
                        switch (type.toLowerCase()) {
                          case 'bank': accentColor = const Color(0xFF3B82F6); break;
                          case 'e-wallet': accentColor = const Color(0xFF8B5CF6); break;
                          default: accentColor = const Color(0xFF10B981);
                        }
                        ...
                        return Expanded(
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Column(
                                children: [
                                  Icon(icon, color: isSelected ? accentColor : (isDark ? Colors.white54 : Colors.black45)),
                    ...
                    GlassInputField(
                      ...
                      onChanged: (_) {
                        if (balanceError != null) setModalState(() => balanceError = null);
                      },
                    ),
                    ...
                    GlassButton(
                      onPressed: () async {
                        ...
                        setModalState(() {
                          ...
                          balanceError = balanceController.text.isEmpty ? 'Required' : null;
                          hasError = nameError != null || balanceError != null;
                        });

                        if (!hasError) {
                          final walletName = nameController.text;
                          final initialBalance = ThousandsFormatter.parse(balanceController.text);
                      ...
                      child: Text(
                        walletToEdit == null ? 'Create Wallet' : 'Save Wallet',
                                    ...
                                    GlassButton(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 8),
                                          Text('wallets.btn_add_wallet'.tr(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                    ),
                                  ],
                              ...
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final colors = _getGradientForType(wallet.type, isDark);

                                    return AnimatedAlign(
                                      duration: const Duration(milliseconds: 400),
                                      curve: Curves.easeOutBack, // Bouncy bounce
                                      ...
                                      child: InteractivePressFeedback(
                                        ...
                                        child: AnimatedContainer(
                                          duration: const Duration(milliseconds: 400),
                                          curve: Curves.easeOutBack, // Bouncy height transition
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            boxShadow: [
                                              BoxShadow(
                                                color: colors[1].withValues(alpha: isSelected ? 0.35 : 0.15),
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            InteractivePressFeedback(
                                                              onTap: () {
                                                                HapticFeedback.lightImpact();
                                                                _showWalletFormBottomSheet(walletToEdit: wallet);
                                                              },
                                                              child: Container(
                                                            ...
                                                            InteractivePressFeedback(
                                                              onTap: () async {
                                                                ...
                                                                if (confirmed == true && context.mounted) {
                                                                  ...
                                                                  setState(() => _selectedWalletIndex = null);
                                                                }
                                                              },
                                                              child: Container(
                                                                padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      ...
      floatingActionButton: Consumer(
        builder: (context, ref, child) {
          ...
          return FloatingActionButton.extended(
            ...
            label: Text('wallets.btn_add_wallet'.tr(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
...
class InteractivePressFeedback extends StatefulWidget {
  ...
  @override
  State<InteractivePressFeedback> createState() => _InteractivePressFeedbackState();
}
