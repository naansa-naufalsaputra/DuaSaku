...
class _ManageCategoriesScreenState extends ConsumerState<ManageCategoriesScreen> {
  ...
  void _showCategoryModal({CategoryModel? categoryToEdit}) {
    ...
    bool isCustomColor = categoryToEdit?.color != null && categoryToEdit?.color != 'system';
    String selectedColor = isCustomColor ? categoryToEdit!.color!.replaceAll('#', '') : 'F43F5E';
                    ...
                    children: [
                      Expanded(
                        child: GlassButton(
                          ...
                          child: const Text('Expense', style: TextStyle(color: Color(0xFFF43F5E), fontWeight: FontWeight.bold)),
                        ),
                      ),
                      ...
                      Expanded(
                        child: GlassButton(
                          ...
                          child: const Text('Income', style: TextStyle(color: Color(0xFF10B981), fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ],
                  ),
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              setModalState(() {
                                ...
                                try {
                                  final parsedColor = Color(int.parse('0xFF$colorHex'));
                                  final hsv = HSVColor.fromColor(parsedColor);
                                  currentHue = hsv.hue;
                                } catch (_) {}
                              });
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                colors: List.generate(7, (i) => HSVColor.fromAHSV(1.0, i * 60.0, 0.85, 0.90).toColor()),
                              ),
                            ),
                          ),
                          Slider(
                            ...
                            onChanged: (val) {
                              ...
                              setModalState(() {
                                currentHue = val;
                                final newColor = HSVColor.fromAHSV(1.0, val, 0.85, 0.90).toColor();
                                selectedColor = newColor.toARGB32().toRadixString(16).substring(2).toUpperCase();
                              });
                            },
                          ),
                        ],
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, idx) {
                        ...
                        final activeColor = isCustomColor 
                            ...
                            : (type == 'expense' ? const Color(0xFFF43F5E) : const Color(0xFF10B981));
                  ...
                  GlassButton(
                    onPressed: () async {
                      if (nameCtrl.text.isNotEmpty) {
                        ...
                        final finalColor = isCustomColor ? '#$selectedColor' : 'system';
                    ...
                    child: Text(
                      categoryToEdit == null ? 'Create Category' : 'Save Changes',
                    ...
                    data: (categories) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final activeColor = _getCategoryColor(cat.color, cat.type);
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      if (cat.id != null) {
                                        ...
                                        ref.read(categoryNotifierProvider.notifier).deleteCategory(cat.id!);
                                      }
                                    },
                                  ),
                                ],
